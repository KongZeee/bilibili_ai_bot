...
MEMORY_FIELD_CONTRACT = {
    ...
    "link_enrichment_timeout_seconds": "restart_account",
    "enrichment_worker_concurrency": "restart_account",
...
MEMORY_CONFIG_FIELD_MAP = {
    ...
    "memory.recall_total_timeout_seconds": {
        "owner": "MemoryRecallEngine",
        "reload_level": "restart_account",
        "test_id": "test_v6_recall_time_budgets",
    },
    ...
    "memory.enrichment_chat_timeout_seconds": {
        "owner": "MemoryBrainWorker",
        "reload_level": "restart_account",
        "test_id": "test_v6_enrichment_limits",
    },
    "memory.link_enrichment_timeout_seconds": {
        "owner": "MemoryBrainWorker",
        "reload_level": "restart_account",
        "test_id": "test_v6_enrichment_limits",
    },
    "memory.enrichment_worker_concurrency": {
        "owner": "MemoryBrainWorker",
        "reload_level": "restart_account",
        "test_id": "test_v6_enrichment_limits",
    },
    "memory.link_candidate_limit": {
        "owner": "MemoryBrainWorker",
        "reload_level": "restart_account",
        "test_id": "test_v6_enrichment_limits",
    },
    "memory.link_job_max_attempts": {
        "owner": "MemoryBrainWorker",
        "reload_level": "restart_account",
        "test_id": "test_v6_enrichment_limits",
    },
    ...
    return {
        ...
        "dynamic_publish": {
            ...
            "fields": {
                ...
                "image_style_custom": {
                    "type": "textarea",
                    "label": "自定义配图风格",
                    "description": "仅在配图风格选择“自定义”时使用，最多 300 字符",
                    "rows": 3,
                },
        ...
        "memory": {
            ...
            "fields": {
                ...
                "link_enrichment_timeout_seconds": {"type": "number", "label": "关联富化超时（秒）"},
                "enrichment_worker_concurrency": {"type": "number", "label": "后台富化并发数"},
